...
class FooterSettingRepository
{
    ...
    public function update($data, $id)
    {
        ...
        $setting->footer_about_title = isset($data['about_title']) ? $data['about_title'] : $item->footer_about_title;
        $setting->footer_about_description = isset($data['about_description']) ? $data['about_description'] : $item->footer_about_description;
        $setting->save();
