            ...
            <div class="col-lg-12">
                ...
                <form action="{{route('AdminSaveCourse')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-{{$col_size}} courseBox" id="subCategoryDiv">
                        ...
                        @if (courseSetting()->show_mode_of_delivery==1)
                            <div class="col-xl-{{$col_size}}  courseBox">
                        ...
                        <div class="primary_input mb-25">
                            ...
                            <div class="row pt-2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="radio" class="common-radio complete_order0"
                                           id="complete_order0" name="complete_order"
                                           value="0" checked>
                                    <label
                                        for="complete_order0">{{__('common.No')}}</label>
                                </div>
                                <div class="col-md-3">
                                    <input type="radio" class="common-radio complete_order1"
                                           id="complete_order1" name="complete_order"
                                           value="1">
                                    <label
                                        for="complete_order1">{{__('common.Yes')}}</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-35">
                                <label class="primary_input_label"
                                    ...
                                    ({{__('common.Max Image Size 1MB')}}) *</label>
                                <div class="primary_file_uploader">
                                    <input class="primary-input filePlaceholder" type="text"
                                           id=""
                                           {{$errors->has('image') ? 'autofocus' : ''}}
                    ...
                    @if(Settings('frontend_active_theme')=="edume")
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label"
                                           for="">{{__('courses.What Wil Learn') }} 1</label>
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label"
                                           for="">{{__('courses.What Wil Learn') }} 2 </label>
