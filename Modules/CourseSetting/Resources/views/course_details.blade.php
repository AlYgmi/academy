                                                ...
                                                <div class="nastable">
                                                    ...
                                                    <div class="row d-flex">
                                                        <div class="col-lg-2">
                                                            ...
                                                            <button class="primary-btn icon-only mr-10 fix-gr-bg"
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="primary_input mb-25">
                                                                    ...
                                                                    <input class="primary_input_field" name="what_learn1" placeholder="-"
                                                                           type="text" value="{{old('what_learn1',@$course->what_learn1)}}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="primary_input mb-25">
                                                                    ...
                                                                    <input class="primary_input_field" name="what_learn2" placeholder="-"
                                                                           type="text" value="{{old('what_learn2',@$course->what_learn2)}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
