                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-effect mt-2 pt-1">
                                ...
                                <select class="primary_select category_id" name="host"
                                        data-key="{{isset($editLesson)? $editLesson->id:$key}}"
                                        id="category_id{{isset($editLesson)? $editLesson->id:$key}}">
                            ...
                            <div class="input-effect mt-2 pt-1"
                                 id="videoUrl{{isset($editLesson)? $editLesson->id:$key}}"
                            ...
                            <div class="input-effect mt-2 pt-1"
                                 id="iframeBox{{isset($editLesson)? $editLesson->id:$key}}"
                            ...
                            <div class="input-effect mt-2 pt-1"
                                 id="vimeoUrl{{isset($editLesson)? $editLesson->id:$key}}"
                                        ...
                                        <div class="primary_file_uploader">
                                            ...
                                            <button class="" type="button">
                                                <label
                                                    ...
                                                    for="document_file_thumb_vimeo_lesson_section_insider">{{__('common.Browse') }}</label>
                                                <input type="file"
                                                       class="d-none fileUpload"
                                                       name="vimeo"
                                                       id="document_file_thumb_vimeo_lesson_section_insider">
                                            </button>
                                        </div>
                                    @else
                            ...
                            <div class="input-effect mt-2 pt-1"
                                 id="VdoCipherUrl{{isset($editLesson)? $editLesson->id:$key}}"
                                 style="display: @if((isset($editLesson) && ($editLesson->host!="VdoCipher")) || !isset($editLesson)) none  @endif">
                                <div class="" id="">

                                    <select class="primary_select" name="vdocipher"
                                            id="VdoCipherVideo">
                                        <option
                                            data-display="{{__('common.Select')}} video "
                                            value="">{{__('common.Select')}} video
                            ...
                            {{--                                                            SCORM--}}
                            <div class="input-effect mt-2 pt-1"
                                 id="fileupload{{isset($editLesson)? $editLesson->id:$key}}"
