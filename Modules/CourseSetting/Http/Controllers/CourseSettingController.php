...
class CourseSettingController extends Controller
{
    ...
    public function getAllCourse()
    {
        try {
            ...
            return view('coursesetting::courses', compact('sub_lists', 'levels', 'video_list', 'vdocipher_list', 'title', 'quizzes', 'courses', 'getsmSetting', 'categories', 'languages', 'instructors'));
        } catch (Exception $e) {
    ...
    public function courseSortBy(Request $request)
    {
        ...
        try {
            ...
            $levels = CourseLevel::where('status', 1)->get();
            $sub_lists = $this->getSubscriptionList();
            return view('coursesetting::courses', compact('sub_lists', 'levels', 'category_search', 'vdocipher_list', 'category_instructor', 'category_type', 'category_status', 'video_list', 'quizzes', 'courses', 'getsmSetting', 'categories', 'languages', 'instructors'));
...
//                    $img->resize(270, 181);
                ...
                $course->about = clean($request->about);
                $course->requirements = clean($request->requirements);
                $course->outcomes = clean($request->outcomes);
...
//                $img->resize(270, 181);
    ...
    public function CourseQuetionShow($question_id, $id, $chapter_id, $lesson_id)
    {
        try {
            ...
            // return $quizzes;
            return view('coursesetting::course_details', compact('data', 'bank', 'vdocipher_list', 'levels', 'video_list', 'course', 'chapters', 'categories', 'getsmSetting', 'instructors', 'languages', 'course_exercises', 'quizzes', 'certificates'));
    ...
    public function CourseLessonShow($id, $chapter_id, $lesson_id)
    {
        try {
            ...
            // return $data;
            return view('coursesetting::course_details', compact('data', 'editLesson', 'levels', 'video_list', 'vdocipher_list', 'course', 'chapters', 'categories', 'getsmSetting', 'instructors', 'languages', 'course_exercises', 'quizzes', 'certificates'));
    ...
    public function CourseChapterShow($id, $chapter_id)
    {
        try {
            ...
            $editChapter = Chapter::where('id', $chapter_id)->first();
            // return $editChapter;
            return view('coursesetting::course_details', compact('data', 'editChapter', 'levels', 'video_list', 'vdocipher_list', 'course', 'chapters', 'categories', 'getsmSetting', 'instructors', 'languages', 'course_exercises', 'quizzes', 'certificates'));
    ...
    public function courseDetails($id, $data = null)
    {
        ...
        // return $quizzes;
        return view('coursesetting::course_details', compact('data', 'vdocipher_list', 'levels', 'video_list', 'course', 'chapters', 'categories', 'getsmSetting', 'instructors', 'languages', 'course_exercises', 'quizzes', 'certificates'));
    ...
    public function getAllCourseData(Request $request)
    {
        ...
        return Datatables::of($query)
            ...
            })->rawColumns(['status', 'price', 'action'])->make(true);
    }
    ...
    public function getVdoCipherList()
    {
        try {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => "https://dev.vdocipher.com/api/videos?page=1&limit=10000",
