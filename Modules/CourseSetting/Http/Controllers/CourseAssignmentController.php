...
class CourseAssignmentController extends Controller
{
    ...
    public function AssignmentStore(Request $request)
    {
        ...
        try {
            ...
            if (isset($course) && isset($chapter)) {
                ...
                send_email(Auth::user(), 'Course_Assignment_Added', [
    ...
    public function CourseAssignmentShow($id, $chapter_id, $lesson_id)
    {
        try {
            ...
            return view('coursesetting::course_details', compact('data', 'edit', 'levels', 'vdocipher_list', 'video_list', 'course', 'chapters', 'categories', 'getsmSetting', 'instructors', 'languages', 'course_exercises', 'quizzes', 'certificates', 'lesson'));
