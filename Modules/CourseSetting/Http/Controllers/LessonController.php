...
class LessonController extends Controller
{
    ...
    public function editLesson($id)
    {
        ...
        try {
            ...
            return view('coursesetting::course_details', compact('levels', 'certificates', 'course', 'chapters', 'categories', 'getsmSetting', 'instructors', 'languages', 'course_exercises', 'editLesson', 'quizzes', 'video_list'));
