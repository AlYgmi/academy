            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    @if (permissionCheck('null'))
                        <form class="form-horizontal" action="{{route('frontend.ContactPageContentUpdate')}}" method="POST"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.Contact Page Banner') }}  <small>({{__('common.Recommended Size')}} 1920x500)</small>
                                                        </label>
