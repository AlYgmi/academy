                                        ...
                                        <div class="col-md-12 item_list">
                                            ...
                                            @foreach($blocks as $block)
                                                ...
                                                @elseif($block->id==6)
                                                    ...
                                                    {{-- Start Compact Theme --}}
                                                @elseif($block->id==13 && Settings('frontend_active_theme')=='compact')
                                                    <div data-id="{{$block->id}}" class="row">
                                                        <div class="col-xl-12 ">
                                                            <div class="mb_25">
                                                                <label class="switch_toggle "
                                                ...
                                                @elseif($block->id==16)
                                                    ...
                                                    {{--
                                                      ...
                                                      <div class="col-xl-4">
                                                          <div class="primary_input mb-25">
                                                              <label class="primary_input_label"
                                                                     for="">{{ __('frontendmanage.Details') }}</label>
                                                              <input class="primary_input_field"
                                                      ...
                                                      <div class="col-xl-4">
                                                          <div class="primary_input mb-25">
                                                              ...
                                                              <input class="primary_input_field"
                                                                     placeholder="{{ __('frontendmanage.Details') }}"
                                                                     type="text"
                                                                     name="how_to_buy_icon1"
                                                                     {{ $errors->has('how_to_buy_icon1') ? ' autofocus' : '' }}
                                                                     value="{{isset($home_content)? $home_content->how_to_buy_icon1 : ''}}">
                                                          </div>
                                                      </div>
