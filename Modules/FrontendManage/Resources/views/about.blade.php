                                            ...
                                            <div class="primary_input mb-25">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <label
                                                            for="testimonial0">{{__('common.No')}}</label>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="radio"
                                                        ...
                                                        <label
                                                            for="testimonial1">{{__('common.Yes')}}</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="primary_input mb-25">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <label
                                                            for="show_brand0">{{__('common.No')}}</label>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="radio"
                                                               class="common-radio drip1"
                                                        ...
                                                        <label
                                                            for="show_brand1">{{__('common.Yes')}}</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="radio"
                                                               ...
                                                               value="0" {{@$about->show_testimonial==0?"checked":""}}>
                                                        <label
                                                            for="show_become_instructor0">{{__('common.No')}}</label>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="radio"
                                                               class="common-radio drip1"
                                                               ...
                                                               value="1" {{@$about->show_testimonial==1?"checked":""}}>
                                                        <label
                                                            for="show_become_instructor1">{{__('common.Yes')}}</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
