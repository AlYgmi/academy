                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.Course Page Banner') }}  <small>({{__('common.Recommended Size')}} 1920x500)</small>
                                                        </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.Class Page Banner') }}  <small>({{__('common.Recommended Size')}} 1920x500)</small>
                                                        </label>
                                                        <div class="primary_file_uploader">
                                                            <input
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.Quiz Page Banner') }}  <small>({{__('common.Recommended Size')}} 1920x500)</small>
                                                        </label>
                                                        <div class="primary_file_uploader">
                                                            <input
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.Instructor Page Banner') }}  <small>({{__('common.Recommended Size')}} 1920x500)</small>
                                                        </label>
                                                        <div class="primary_file_uploader">
                                                            <input
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.Become Instructor Page Banner') }}  <small>({{__('common.Recommended Size')}} 1920x500)</small>
                                                        </label>
                                                        <div class="primary_file_uploader">
                                                            <input
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.About Page Banner') }}  <small>({{__('common.Recommended Size')}} 1920x500)</small>
                                                        </label>
                                                        <div class="primary_file_uploader">
                                                            <input
                                                                class="primary-input  filePlaceholder {{ @$errors->has('instructor_page_banner') ? ' is-invalid' : '' }}"
                                            ...
                                            @if(isModuleActive('Subscription'))
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                                   for="">{{ __('frontendmanage.Subscription Page Banner') }}  <small>({{__('common.Recommended Size')}} 1920x500)</small>
                                                            </label>
                                                            <div class="primary_file_uploader">
                                                                <input
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.Blog Page Banner') }}  <small>({{__('common.Recommended Size')}} 1920x500)</small>
                                                        </label>
                                                        <div class="primary_file_uploader">
                                                            <input
