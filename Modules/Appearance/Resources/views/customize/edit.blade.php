                ...
                <div class="row form">
                        ...
                        <div class="primary_input">
                            ...
                            <select class="primary_select mb-15 theme" name="theme" id="theme">
                                @foreach($themes as $theme)
                                    <option
                                        value="{{$theme->id}}" {{$theme->id==$editData->id?'selected':''}}>{{$theme->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-3">
                        <div class="primary_input mb-15">
                            ...
                            <input type="color" name="footer_background_color" value="{{ $editData->footer_background_color }}"
                                   class="primary_input_field color_field"
                                   required>
                    ...
                    <div class="col-lg-3">
                        <div class="primary_input mb-15">
                            ...
                            <input type="color" name="footer_headline_color" value="{{ $editData->footer_headline_color }}"
                                   class="primary_input_field color_field"
                                   required>
