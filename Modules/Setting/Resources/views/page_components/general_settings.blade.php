                                ...
                                <select class="primary_select mb-25" name="currency_id" id="currency_id">
                                    @foreach ($currencies as $key => $currency)
                                        <option value="{{ $currency->id }}"
                                                @if (Settings('currency_id')  == $currency->id) selected @endif>{{ $currency->name }} - {{ $currency->code }}
                                            ({{ $currency->symbol }})
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <select class="primary_select mb-25" name="student_reg" id="student_reg">
                                    <option value="1"
                                            @if ($setting->student_reg == 1) selected @endif>{{ __('common.Enable') }}</option>
                                    <option value="0"
                                            @if ($setting->student_reg == 0) selected @endif>{{ __('common.Disable') }}</option>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" placeholder="0 means Unlimited" type="number" min="0"
                                       ...
                                       name="device_limit_time" value="{{ $setting->device_limit_time }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" placeholder="-" type="text" id="google_analytics"
                                       name="google_analytics" value="{{ $setting->google_analytics }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <select class="primary_select mb-25" name="category_show"
                                        id="category_show">
                                    <option value="1"
                                            @if ($setting->category_show == 1) selected @endif>Show
                                    </option>

                                    <option value="0"
                                            @if ($setting->category_show == 0) selected @endif>Hide
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <select class="primary_select mb-25" name="footer_show"
                                        id="currency_conversion">
                                    <option value="1"
                                            @if ($setting->footer_show == 1) selected @endif>Show
                                    </option>

                                    <option value="0"
                                            @if ($setting->footer_show == 0) selected @endif>Hide
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <select class="primary_select mb-25" name="show_cart"
                                        id="show_cart">
                                    <option value="1"
                                            @if ($setting->show_cart == 1) selected @endif>Show
                                    </option>

                                    <option value="0"
                                            @if ($setting->show_cart == 0) selected @endif>Hide
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <select class="primary_select mb-25" name="course_approval"
                                        id="course_approval">
                                    <option value="1"
                                            @if ($setting->course_approval == 1) selected @endif> Yes
                                    </option>

                                    <option value="0"
                                            @if ($setting->course_approval == 0) selected @endif> No
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" placeholder="-" type="text" id="facebook_pixel"
                                       name="facebook_pixel" value="{{ $setting->facebook_pixel }}">
                            </div>
                        </div>
