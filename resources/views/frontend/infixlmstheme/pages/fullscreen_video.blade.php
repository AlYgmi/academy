                                ...
                                @php
                                    $timer =0;
                                        ...
                                        if(!empty($lesson->lessonQuiz->question_time_type==1)){
                                           ...
                                           $timer= $lesson->lessonQuiz->question_time*count($lesson->lessonQuiz->assign);
                                        }
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="nav question_number_lists" id="nav-tab"
                                                 role="tablist">
                                                @if(isset($lesson->lessonQuiz->assign))
                                                    @foreach($lesson->lessonQuiz->assign as $key2=>$assign)
                               ...
                               <div class="tabControl">
                                   <div class="row">
                                       ...
                                       <div class="col-xl-6">
                                           ...
                                           <div class="question_list_header">
                                               <div class="question_list_top">
                                                   <p>Question <span id="currentNumber">{{$count2}}</span> out
                                                       of {{count($lesson->lessonQuiz->assign)}}</p>
                                               </div>
                                           </div>
                                           <div class="nav question_number_lists" id="nav-tab"
