                    ...
                    if ($couponApply) {
                        if ($type == 0) {
                            ...
                            if ($discount >= $max_dis) {
                                ...
                                $final = ($total - $max_dis);
                                $checkout->discount = number_format(getPriceAsNumber($max_dis), 2);
                                $checkout->purchase_price = number_format(getPriceAsNumber($final), 2);
                            } else {

                                $final = ($total - $discount);
                                $checkout->discount = number_format(getPriceAsNumber($discount), 2);
                                $checkout->purchase_price = number_format(getPriceAsNumber($final), 2);
