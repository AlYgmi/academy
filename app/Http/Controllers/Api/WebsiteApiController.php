...
// return $review;
    ...
    public function paytmOrderGenerate(Request $request)
    {
        ...
        try {
            ...
            $body['mid'] = env('PAYTM_MERCHANT_ID');
            $body['key_secret'] = env('PAYTM_MERCHANT_KEY');
            $body['website'] = env('PAYTM_MERCHANT_WEBSITE');
            $body['orderId'] = $track;
            ...
            $paytmChecksum = PaytmChecksum::generateSignature(json_encode($body), env('PAYTM_MERCHANT_KEY'));
    ...
    public function paytmOrderVerify(Request $request)
    {
        ...
        try {
            ...
            $isVerifySignature = PaytmChecksum::verifySignature($paytmParams, env('PAYTM_MERCHANT_KEY'), $request->paytmChecksum);
