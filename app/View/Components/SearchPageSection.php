...
class SearchPageSection extends Component
{
    ...
    public function render()
    {
        $query = Course::orderBy('total_enrolled', 'desc')
            ->with('user', 'enrolls', 'comments', 'reviews', 'lessons', 'activeReviews', 'enrollUsers', 'class', 'cartUsers', 'quiz', 'quiz.assign');
        ...
        return view(theme('components.search-page-section'), compact('levels', 'search', 'order','mode', 'category', 'level', 'order', 'language', 'type', 'total', 'courses'));
    }
}
